...
class Foodmenuorder {
    ...
    public static function createNewFoodmenuorder(Foodmenuorder $fmo): bool {
        return Database::execute("INSERT INTO `foodmenuorder` (`id`, `username`, `customerName`, `foodTitle`, `price`) VALUES (NULL, '" . $fmo->username . "', '" . $fmo->customerName . "', '" . $fmo->foodTitle . "', '" . $fmo->price . "')");
    }
